...
export default function PublishRideSeatsScreen({ navigation, route }: Props) {
  const [seats, setSeats] = useState(1);
  const { vehicle, plateNumber, pickup, destination, stops, pricePerSeat, date, time } = route.params;
